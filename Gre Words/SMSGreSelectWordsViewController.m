//
//  SMSGreSelectWordsViewController.m
//  Gre Words
//
...
@interface SMSGreSelectWordsViewController ()
@property (strong, nonatomic) IBOutlet UITableView *wordsTable;

@end

@implementation SMSGreSelectWordsViewController
...
- (void)viewDidLoad
{
    ...
    self.wordsTable.backgroundColor = [SMSAppDelegate appDelegate].backGroundColor;
